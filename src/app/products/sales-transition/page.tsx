    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-8">Sales Transition System</h1>
          <p className="text-xl mb-8">Scale from founder-led to team sales without losing momentum</p>
          
          <div className="bg-white rounded-lg shadow-lg p-12">
            <h2 className="text-2xl font-semibold mb-6">Coming Soon</h2>
            <p className="text-gray-600 mb-8">
              We're putting the finishing touches on this GTM system. 
