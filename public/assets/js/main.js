(function ($) {
   ...
   ///Create an account toggle function
	...
	if ($('#smooth-wrapper').length > 0 && typeof gsap !== 'undefined') {
		///////////////////////////////////////////////////
   ...
   if ($('.tp-gsap-bg').length > 0 && typeof gsap !== 'undefined') {
   ...
   if ($('.tp-hero-bg-single').length > 0 && typeof gsap !== 'undefined') {
...
if ($('.tp-header-top-animation').length > 0 && typeof gsap !== 'undefined') {
	...
	if ($('.pr-feature-box').length > 0 && typeof ScrollTrigger !== 'undefined') {
	...
	if ($('.social-box-pin').length > 0 && typeof ScrollTrigger !== 'undefined') {
	ScrollTrigger.create({
